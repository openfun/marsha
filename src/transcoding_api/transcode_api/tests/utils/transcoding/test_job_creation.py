...
from transcode_api.factories import RunnerJobFactory, VideoFactory, VideoFileFactory
...
class JobCreationTestCase(TestCase):
    ...
    @patch("transcode_api.utils.transcoding.job_creation.VODHLSTranscodingJobHandler")
    @patch(
        "transcode_api.utils.transcoding.job_creation.build_lower_resolution_job_payloads"
    )
