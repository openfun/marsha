...
from transcode_api.models import RunnerJobType
...
class TestVODHLSTranscodingJobHandler(TestCase):
    ...
    @patch(
        "transcode_api.utils.job_handlers.vod_hls_transcoding_job_handler.on_hls_video_file_transcoding"
    )
    @patch(
        "transcode_api.utils.job_handlers.vod_hls_transcoding_job_handler.on_transcoding_ended"
    )
    @patch(
        "transcode_api.utils.job_handlers.vod_hls_transcoding_job_handler.rename_video_file_in_playlist"
    )
    @patch(
        "transcode_api.utils.job_handlers.vod_hls_transcoding_job_handler.build_new_file",
    )
    @patch(
        "transcode_api.utils.job_handlers.vod_hls_transcoding_job_handler.generate_hls_video_filename",
    )
