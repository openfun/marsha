...
from django_peertube_runner_connector.models import RunnerJob, RunnerJobState, RunnerJobType, Video
...
class TranscodeVideoAPITest(TestCase):
    ...
    def test_transcode_video(self):
        ...
        with patch.object(ffmpeg, "probe", return_value=probe_response), patch.object(
            ...
            "django_peertube_runner_connector.utils.job_handlers.abstract_job_handler.send_available_jobs_ping_to_runners",
        ) as ping_mock:
