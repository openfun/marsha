...
from django_peertube_runner_connector.factories import RunnerJobFactory, VideoFactory, VideoJobInfoFactory
...
class TestAbstractVODHLSTranscodingJobHandler(TestCase):
    ...
    @patch(
        "django_peertube_runner_connector.utils.job_handlers.abstract_vod_transcoding_job_handler.move_to_failed_transcoding_state"
    )
    ...
    @patch(
        "django_peertube_runner_connector.utils.job_handlers.abstract_vod_transcoding_job_handler.move_to_next_state"
    )
