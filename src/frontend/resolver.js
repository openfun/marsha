module.exports = (path, options) => {
  ...
  return options.defaultResolver(path, {
    ...
    packageFilter: (pkg) => {
      // This is a workaround for https://github.com/uuidjs/uuid/pull/616 and other packages
      // that not use commonJS style export.
      //
      ...
      if (['uuid', 'periscopic'].includes(pkg.name)) {
        delete pkg['exports'];
        delete pkg['module'];
      }
      return pkg;
