...
describe('<CameraControl />', () => {
  ...
  it('renders camera on svg when video is on', async () => {
    ...
    await screen.findByTestId('jitsi-camera-on');
  });
  ...
  it('renders camera off svg when video is off', async () => {
    ...
    await screen.findByTestId('jitsi-camera-off');
  });
  ...
  it('listens to jitsi video changes', async () => {
    ...
    expect(screen.queryByTestId('jitsi-camera-on')).not.toBeInTheDocument();
    expect(screen.queryByTestId('jitsi-camera-off')).not.toBeInTheDocument();
