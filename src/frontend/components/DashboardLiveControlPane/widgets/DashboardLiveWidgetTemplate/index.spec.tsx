...
import { DashboardLiveWidgetTemplate } from '.';
...
describe('<DashboardLiveWidgetTemplate />', () => {
  it('renders DashboardLiveWidgetTemplate opened, with an info text ', () => {
    render(
  ...
  it('renders DashboardLiveWidgetTemplate closed without info text and clicks on the title.', () => {
    render(
      <InfoWidgetModalProvider value={null}>
        <DashboardLiveWidgetTemplate
  ...
  it('renders DashboardLiveWidgetTemplate closed with info text and clicks on info button', async () => {
    render(
      <InfoWidgetModalProvider value={null}>
        <DashboardLiveWidgetTemplate
          initialOpenValue={false}
