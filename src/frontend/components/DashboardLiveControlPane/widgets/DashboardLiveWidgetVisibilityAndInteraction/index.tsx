...
import { DashboardLiveWidgetDashedBoxCustom } from 'components/DashboardLiveControlPane/customs/DashboardLiveWidgetDashedBoxCustom';
import { DashboardLiveWidgetToggleInput } from 'components/DashboardLiveControlPane/inputs/DashboardLiveWidgetToggleInput';
...
const messages = defineMessages({
  info: {
    ...
    id: 'components.DashboardLiveWidgetVisibilityAndInteraction.info',
  },
  title: {
    ...
    id: 'components.DashboardLiveWidgetVisibilityAndInteraction.title',
  },
  publiclyAvailableLabel: {
    ...
    id: 'components.DashboardLiveWidgetVisibilityAndInteraction.publiclyAvailableLabel',
  },
  copyButtonTitle: {
    defaultMessage:
    ...
    id: 'components.DashboardLiveWidgetVisibilityAndInteraction.copyButtonTitle',
  },
  copySuccess: {
    defaultMessage: 'Url copied in clipboard !',
    description:
      "Message displayed when video's publicly available url is copied in clipboard.",
    id: 'components.DashboardLiveWidgetVisibilityAndInteraction.copySuccess',
  },
  updateVideoSucces: {
    defaultMessage: 'Video updated.',
    description: 'Message displayed when video is successfully updated.',
    id: 'component.DashboardLiveWidgetVisibilityAndInteraction.updateVideoSucces',
  },
  updateVideoFail: {
    defaultMessage: 'Video update has failed !',
    description: 'Message displayed when video update has failed.',
    id: 'component.DashboardLiveWidgetVisibilityAndInteraction.updateVideoFail',
  },
});

export const DashboardLiveWidgetVisibilityAndInteraction = () => {
