...
describe('<SubscribeScheduledVideoEmailForm />', () => {
  ...
  it('shows the input for the email when prop email is not defined', async () => {
    render(
      wrapInIntlProvider(
        <Grommet>
  ...
  it('shows the input for the email when email is null', async () => {
    render(
      wrapInIntlProvider(
        <Grommet>
  ...
  it('shows the input for the email when email is empty', async () => {
    render(
      wrapInIntlProvider(
        <Grommet>
  ...
  it('shows the register button and no input email form when email is defined in props', async () => {
    render(
      wrapInIntlProvider(
        <Grommet>
          <SubscribeScheduledVideoEmailForm
  ...
  it('fails with a non valid request', async () => {
    ...
    getByText(
      'Impossible to register your email chantal@aol.com for this event. Are you sure, your email is valid otherwise, please try again later or contact us.',
    );
  });
});
