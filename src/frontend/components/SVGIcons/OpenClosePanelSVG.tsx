  ...
  return (
    <SVGIcon viewBox={{ x: 0, y: 0, width: 26, height: 26 }} {...svgProps}>
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g transform="translate(-1249.000000, -997.000000)">
          <g transform="translate(1262.000000, 1010.000000) rotate(-180.000000) translate(-1262.000000, -1010.000000) translate(1249.000000, 997.000000)">
            <rect
              fill="#055FD2"
              x="0"
              y="0"
