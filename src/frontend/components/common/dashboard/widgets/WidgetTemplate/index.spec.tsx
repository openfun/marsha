...
describe('<WidgetTemplate />', () => {
  it('renders WidgetTemplate opened, with an info text ', () => {
    render(
  ...
  it('renders WidgetTemplate closed without info text and clicks on the title.', () => {
    render(
      <InfoWidgetModalProvider value={null}>
        <WidgetTemplate initialOpenValue={false} title={genericTitle}>
          <GenericComponent />
        </WidgetTemplate>
      </InfoWidgetModalProvider>,
    );
  ...
  it('renders WidgetTemplate closed with info text and clicks on info button', async () => {
    render(
      <InfoWidgetModalProvider value={null}>
        <WidgetTemplate
