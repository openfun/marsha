...
const messages = defineMessages({
  info: {
    defaultMessage:
      'This widget allows you upload a video to replace the current one.',
...
interface InstructorDashboardVODWidgetUploadVideoProps {
  video: Video;
}

export const InstructorDashboardVODWidgetUploadVideo = ({
  video,
}: InstructorDashboardVODWidgetUploadVideoProps) => {
  const intl = useIntl();
