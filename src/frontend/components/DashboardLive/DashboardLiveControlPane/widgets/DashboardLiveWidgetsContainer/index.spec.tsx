...
import { DashboardLiveWidgetsContainer } from '.';
...
describe('<DashboardLiveWidgetContainer />', () => {
  it('renders DashboardLiveWidgetContainer empty', () => {
    const { elementContainer: container } = render(
      <InfoWidgetModalProvider value={null}>
        <DashboardLiveWidgetsContainer>{[]}</DashboardLiveWidgetsContainer>
      </InfoWidgetModalProvider>,
    );
    expect(container).toBeEmptyDOMElement();
  });

  it('renders DashboardLiveWidgetContainer on a large screen', () => {
    const { elementContainer: container } = render(
  ...
  it('renders DashboardLiveWidgetContainer on a medium screen', () => {
    const { elementContainer: container } = render(
  ...
  it('renders DashboardLiveWidgetContainer on a small screen', () => {
    const { elementContainer: container } = render(
