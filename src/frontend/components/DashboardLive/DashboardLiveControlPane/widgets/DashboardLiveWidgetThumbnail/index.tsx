...
const messages = defineMessages({
  title: {
    ...
    id: 'components.DashboardLiveWidgetThumbnail.title',
  },
  infoLive: {
    defaultMessage:
    ...
    id: 'components.DashboardLiveWidgetThumbnail.infoLive',
  },
  infoVOD: {
    defaultMessage:
      'This widget allows you to change the default thumbnail used for your VOD. The uploaded image should have a 16:9 ratio.',
    description: 'Helper explaining how to use the widget.',
    id: 'components.DashboardLiveWidgetThumbnail.infoVOD',
  },
  uploadThumbnailButtonLabel: {
    defaultMessage: 'Upload an image',
    description: 'Label of the upload image button.',
    id: 'components.DashboardLiveWidgetThumbnail.uploadThumbnailButtonLabel',
  },
});

interface DashboardLiveWidgetThumbnailProps {
  isLive?: boolean;
}

export const DashboardLiveWidgetThumbnail = ({
  isLive = true,
}: DashboardLiveWidgetThumbnailProps) => {
