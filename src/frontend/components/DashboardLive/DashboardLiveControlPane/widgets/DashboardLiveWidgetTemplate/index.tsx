...
const messages = defineMessages({
  helpButtonTitle: {
    ...
    id: 'components.DashboardLiveWidgetTemplate.helpButtonTitle',
  },
});
...
interface DashboardLiveWidgetTemplateProps {
...
export const DashboardLiveWidgetTemplate = ({
  children,
  infoText,
  initialOpenValue,
  title,
}: DashboardLiveWidgetTemplateProps) => {
  const intl = useIntl();
