...
const messages = defineMessages({
  confirmButtonLabel: {
    ...
    id: 'components.DashboardLiveConfirmationModal.confirmButtonLabel',
  },
  cancelButtonLabel: {
    defaultMessage: 'Cancel',
    description: 'Label of the cancelling button',
    id: 'components.DashboardLiveConfirmationModal.cancelButtonLabel',
  },
});
...
interface DashboardLiveConfirmationModalProps {
  text: string;
  title: string;
...
export const DashboardLiveConfirmationModal = ({
  text,
  title,
  onModalCloseOrCancel,
  onModalConfirm,
}: DashboardLiveConfirmationModalProps) => {
  const intl = useIntl();
