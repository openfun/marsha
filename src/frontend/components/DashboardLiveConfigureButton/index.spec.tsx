...
import { DashboardLiveConfigureButton } from '.';

jest.mock('data/stores/useAppConfig', () => ({
  useAppConfig: () => ({}),
}));

describe('components/DashboardLiveConfigureButton', () => {
  afterEach(() => fetchMock.restore());

  it('displays the configure live button', () => {
    const video = videoMockFactory();
    render(
      <DashboardLiveConfigureButton video={video} type={LiveModeType.JITSI} />,
    );
