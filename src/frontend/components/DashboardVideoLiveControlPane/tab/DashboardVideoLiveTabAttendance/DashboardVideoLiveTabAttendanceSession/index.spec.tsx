...
describe('<DashboardVideoLiveTabAttendanceSession />', () => {
  it('renders the livesession with no activity and the username is bold if the user was registered', async () => {
    const liveSession = {
  ...
  it('renders the livesession with partial activity and the username is not bold if the user was not registered', async () => {
    const liveSession = {
      id: 'id',
      display_name: 'sam',
      is_registered: false,
  ...
  it('renders the livesession with diligent activity', async () => {
    const liveSession = {
      id: 'id',
      display_name: 'sam',
      is_registered: false,
  ...
  it('considers user to be present when he was connected in between', async () => {
    const liveSession = {
      id: 'id',
      display_name: 'sam',
      is_registered: false,
  ...
  it('considers user to be present when he was on stage', async () => {
    const liveSession = {
      id: 'id',
      display_name: 'sam',
      is_registered: false,
  ...
  it('renders the livesession with no activity if there is no timeline for the video', async () => {
    const liveSession = {
      id: '34d73670-885c-4a84-b208-8246bfd05949',
      display_name: 'sam',
      is_registered: true,
