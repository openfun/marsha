"""Tests for the end_session service in the ``bbb`` app of the Marsha project."""
...
from marsha.bbb.utils.bbb_utils import end_session


@override_settings(BBB_API_ENDPOINT="https://10.7.7.1/bigbluebutton/api")
@override_settings(BBB_API_SECRET="SuperSecret")
class ClassroomServiceEndSessionTestCase(TestCase):
    """Test our intentions about the Classroom end_session service."""

    maxDiff = None

    @responses.activate
    def test_end_session(self):
        """When ending a session, store the ending date, and the learning analytics."""
        ...
        with mock.patch(
            ...
            end_session(classroom_session.classroom)
