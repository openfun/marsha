...
class MockedRenaterShibbolethSAMLAuth(RenaterShibbolethSAMLAuth):
    ...
    def get_idp(self, idp_name):
        ...
        return SAMLIdentityProvider(
            ...
            url="http://marcha.local/idp/sso/",  # unused
            slo_url="http://marcha.local/idp/slo/",  # unused
            x509cert=get_dev_certificate(),  # unused
            marsha_display_name="Marsha local IdP",  # unused
            marsha_organization_name="Marsha organization name",  # unused
            marsha_organization_display_name=self.organization_display_name,
        )
...
class OrganizationPipelineTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.backend = MockedRenaterShibbolethSAMLAuth(
            load_strategy(),
    ...
    def test_create_organization_from_saml_new_user_new_organization(self):
        ...
        new_backend = MockedRenaterShibbolethSAMLAuth(
            load_strategy(),
            redirect_uri="http://testserver/",
