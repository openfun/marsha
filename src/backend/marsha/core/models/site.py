...
from .account import RESOURCES_CHOICES
from .base import BaseModel


class SiteConfig(BaseModel):
    """Model to extend the django site table."""
    ...
    inactive_content_types = InvertedArrayField(
        models.CharField(
        ...
        verbose_name=_("active content types"),
        help_text=_("list of inactive content types for this site."),
        default=list,
        blank=True,
    )
