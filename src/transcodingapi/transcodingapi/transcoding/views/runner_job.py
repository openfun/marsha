...
from ..models import Runner, RunnerJob, RunnerJobState, Video
...
class RunnerJobViewSet(mixins.DestroyModelMixin, ListMixin, viewsets.GenericViewSet):
    ...
    def get_max_quality_video_file(self, request, uuid=None, video_id=None):
        ...
        video_file_path = get_fs_video_file_output_path(video_file=video_file)
    ...
    def cancel_runner_job(self, request, uuid=None):
        return Response(status=status.HTTP_204_NO_CONTENT)
