...
The LRS' endpoint used to send xAPI statement.

- Type: string
- Required: No
- Default: None

#### DJANGO_LRS_AUTH_TOKEN

An authentication token generated by your LRS and used to authenticate every request made to save a xAPI statement.
This token will be found in you LRS interface, it should be a Basic Auth token.
